      ...
      return `
        <div class="note-card">
          ...
          <div class="nc-actions">
            ...
            <button class="btn-view" onclick="window.open('${n.pdfLink}', '_blank')">👁 View</button>
            <button class="btn-dl" onclick="downloadNote('${n.id}')">⬇ Save</button>
          </div>
        </div>
      `;
    }).join('');
  ...
  list.innerHTML = notes.map(n => `
    <div class="admin-note-card">
      ...
      <div class="anc-actions">
        ${n.pdfLink ? `<button class="anc-btn view" onclick="window.open('${n.pdfLink}','_blank')">👁 Preview</button>` : ''}
